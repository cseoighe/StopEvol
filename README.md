...
The R script [StopCodon](https://github.com/cseoighe/stopcodon.rscript) requires as input, a sequence alignment file in FASTA format and a phylogenetic tree file expaining the relatedness of the alignment.
